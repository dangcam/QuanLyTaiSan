        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4><?=lang('AppLang.page_title_position')?></h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><?=lang('AppLang.page_title_position')?></h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table table-bordered table-striped verticle-middle table-responsive-sm" style="width:100%">
                                <thead>
                                <tr>
                                    <th scope="col"><?=lang('ChucVuLang.ma_cv')?></th>
                                    <th scope="col"><?=lang('ChucVuLang.ten_cv')?></th>
                                    <th scope="col"><?=lang('ChucVuLang.ghi_chu')?></th>
                                ...
                                <tfoot>
                                <tr>
                                    <th><?=lang('ChucVuLang.ma_cv')?></th>
                                    <th><?=lang('ChucVuLang.ten_cv')?></th>
                                    <th><?=lang('ChucVuLang.ghi_chu')?></th>
                                    <th>Action</th>
                                </tr>
                                </tfoot>
                            </table>
            ...
            <form method="post" id="form_id">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label"><?=lang('ChucVuLang.ma_cv')?></label>
                        <input type="text" name="ma_cv" class="form-control" id="ma_cv" required placeholder="<?=lang('ChucVuLang.ma_cv')?>">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label"><?=lang('ChucVuLang.ten_cv')?></label>
                        <input type="text" name="ten_cv" class="form-control" id="ten_cv" required placeholder="<?=lang('ChucVuLang.ten_cv')?>">
                    </div>                    
                    <div class="form-group">
                        <label for="message-text" class="col-form-label"><?=lang('ChucVuLang.ghi_chu')?></label>
                        <input type="text" name="ghi_chu" class="form-control" id="ghi_chu" placeholder="<?=lang('ChucVuLang.ghi_chu')?>">
                    </div>
...
<script>
    jQuery(document).ready(function($) {
        var ajaxDataTable = $('#data-table').DataTable({
            ...
            'ajax': {
                'url': '<?=base_url()?>dashboard/position/position_ajax',
                'data': function (data) {
                },
            },
            'columns': [
