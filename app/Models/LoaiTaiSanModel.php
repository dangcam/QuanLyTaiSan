...
class LoaiTaiSanModel Extends BaseModel
{
    ...
    public function delete_asset($data)
    {
        ...
        if($this->where('ma_loai_ts',$data_id)->delete())
        {
            $this->set_message("LoaiTaiSanLang.asset_delete_successful");
            return 0;
        }else
        {
            $this->set_message("LoaiTaiSanLang.asset_delete_unsuccessful");
            return 3;
        }
    }
